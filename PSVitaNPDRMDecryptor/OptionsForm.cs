	...
	public partial class OptionsForm : Form {
		...
		private void btnHelp_Click(object sender, EventArgs e) {
            MessageBox.Show("This tool works on encrypted PSVita games extracted with \"pkg2zip.exe\" or similar, " +
				"it won't work on PKGs directly. Use the \"Add Folders\" button or drag & drop, select the output directory and \"Start\"", "Instructions", MessageBoxButtons.OK, MessageBoxIcon.Question);
        }
